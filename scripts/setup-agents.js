...
console.log("🚀 Setting up AP Tutor agents...")
...
console.log("Please sign up at https://app.letta.com and create an API key")
...
value: "Student taking AP course. Learning style and specific needs to be determined through interaction.",
...
console.log(`✅ Created ${config.name} (ID: ${agent.id})`)
...
envVars.push(`LETTA_AGENT_${courseId.toUpperCase().replace("-", "_")}=${agent.id}`)
...
console.log(`❌ ${result.courseId}: ${result.error}`)
...
console.log("\n🚀 Your AP Tutor platform is ready!")
